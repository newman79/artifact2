 ...
 */
public class TestClassicWritting  extends TestCase
{
	App app;
    ...
    public static Test suite() { return new TestSuite(TestClassicWritting.class); }

     // Invoqué par lors de la construction de la suite de tests
    public TestClassicWritting(String testName)
    {
